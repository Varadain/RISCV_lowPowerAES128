        ...
        case (opcode_i)
            ...
            7'b0010011: begin // I-type ALU immediate
                ...
                unique case (funct3_i)
                    ...
                    3'b101: alu_ctrl_o = funct7_i[5] ? ALU_SRA : ALU_SRL; // SRAI/SRLI
                    default: alu_ctrl_o = ALU_ADD;
                endcase
            end
...
`ifdef DEBUG_TRACE
    always_comb begin
        $display("[CTRL] opc=%b f3=%b f7=%b alu_ctrl=%h alu_src=%0b br=%0b mr=%0b mw=%0b",
                 opcode_i, funct3_i, funct7_i, alu_ctrl_o, alu_src_o, branch_o, mem_read_o, mem_write_o);
    end
`endif
endmodule
