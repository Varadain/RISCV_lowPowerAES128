module control_unit (
    ...
    always_comb begin
        ...
        case (opcode_o)
            ...
            7'b0000011: begin // Loads (address calc)
                reg_write_o  = 1'b1;
                mem_read_o   = 1'b1;
                mem_to_reg_o = 1'b1;
                alu_src_o    = 1'b1;
            ...
            7'b0100011: begin // Stores (address calc)
                mem_write_o = 1'b1;
                alu_src_o   = 1'b1;
                alu_ctrl_o  = ALU_ADD;
            end
            ...
            7'b1100011: begin // Branches
                ...
                unique case (funct3_o)
                    ...
                    3'b110: alu_ctrl_o = ALU_BLT; // BLTU (core currently compares signed in EX)
                    3'b111: alu_ctrl_o = ALU_BGE; // BGEU (core currently compares signed in EX)
