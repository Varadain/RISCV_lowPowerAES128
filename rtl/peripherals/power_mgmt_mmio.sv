...
module power_mgmt_mmio (
    ...
    // Compact observable checksum-like value used as a top-level debug output.
    // Individual exact counters remain readable through MMIO.
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (clear_counters) begin
                ...
                // Peripheral counters continue to reflect their own activity
                // inputs, allowing wake-up or background activity to be studied.
