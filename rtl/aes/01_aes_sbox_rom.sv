...
//
// The 8-bit input is replaced by the Rijndael substitution value defined by the
// AES standard. Although written as a case statement, synthesis tools may map
// this table to logic or ROM resources depending on the selected technology.
// This table is purely combinational: output c changes with input a.
// -----------------------------------------------------------------------------
...
// Complete 256-entry AES substitution box lookup table.
always @(*) begin
    case (a)
